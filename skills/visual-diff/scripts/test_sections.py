...
def test_mermaid_symbols_wraps_a_long_label_without_touching_ids_arrows_or_classdef():
    ...
    assert "classDef" not in text  # node colour is a page-CSS `.new`/`.gone` class, not mermaid's
...
if __name__ == "__main__":
    tests = [
        ...
        test_symbols_orphan_symbol_is_listed_instead_of_drawn_at_levels_2_and_3,
        ...
        test_level2_scope_drops_edges_touching_a_merely_moved_symbol,
        test_level3_scope_adds_the_context_endpoint_of_a_changed_edge,
